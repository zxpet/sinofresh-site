...
- **仓库级 md5**：新工具 `tools/sf_repo_md5.py`，**1226 个跟踪文件，0 差异，13 个非 ASCII 名逐条 matched**（`cloud-md5.txt`）。它第一次跑就抓到 2 处不一致 —— 正是我本地已修、当时尚未提交的两个门工具的 `say()` 修复，提交后复跑为 0。
...
| `docs/b2d-step4c-shots/cloud-md5.txt` | 仓库级 md5 1226/0 |
