...
self-portrait: live serves 2.10.76 and the candidate serves 2.10.77, so a byte
...
def main():
    ...
    ck('that copy serves 2.10.77', pre_ver == '2.10.77', pre_ver)
    ck('live still serves sinofresh-theme at 2.10.76 (the pull is held back)',
       (live_dir, live_ver) == ('sinofresh-theme', '2.10.76'),
       (live_dir, live_ver))
