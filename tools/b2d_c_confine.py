...
PHP_FUNCS_OPEN = ('/**\n * The nine question/answer pairs of a formula\'s FAQ band '
                  '(batch C).')
# The insert sits between intro()'s tail and the docblock that follows it, so
# the cut has to stop AT the tail, not after it: ending on the docblock would
# take "\treturn $text;\n}\n\n" (18 bytes) with it and the file would come back
# short rather than different.
PHP_FUNCS_TAIL = "\treturn $text;\n}\n\n"
