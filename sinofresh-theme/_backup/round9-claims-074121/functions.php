...
add_action('wp_head', function () {
	...
	// Certifications held (updated 2026-09-17: FSSC 22000 replaces ISO 22000;
	// HACCP and BRC added). Same six credentials are rendered as HTML text in
	// the front-page grid and the quality-page detail rows.
