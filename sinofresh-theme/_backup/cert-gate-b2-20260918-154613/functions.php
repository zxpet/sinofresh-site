...
add_action('wp_enqueue_scripts', function() {
	wp_enqueue_style('sinofresh-style', get_stylesheet_uri(), array(), '2.10.34');
...
add_action('wp_head', function () {
	...
	$schema = array(
		...
		'description' => 'Contract manufacturing services for pet supplements — OEM, ODM, Contract Manufacturing, and Private Label. 8 dosage forms, flexible MOQ, FDA, cGMP, ISO 9001, FSSC 22000.',
