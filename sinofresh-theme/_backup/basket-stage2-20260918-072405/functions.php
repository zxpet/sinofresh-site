...
add_action('wp_enqueue_scripts', function() {
	wp_enqueue_style('sinofresh-style', get_stylesheet_uri(), array(), '2.10.30');
	...
	if (is_front_page()) {
		wp_enqueue_script('sinofresh-hero-slider', get_template_directory_uri() . '/assets/js/hero-slider.js', array(), '1.1.0', true);
	}
});
...
add_action('wp_enqueue_scripts', function() {
	if (is_page('quality') || is_page_template('page-quality')) {
		wp_enqueue_script('sinofresh-quality', get_template_directory_uri() . '/assets/js/quality.js', array(), '1.0.0', true);
	}
});
...
add_action('wp_enqueue_scripts', function() {
	...
	if ($is_dosage_page) {
		wp_enqueue_style('sinofresh-configurator', get_template_directory_uri() . '/assets/css/configurator.css', array(), '2.5');
		// Basket storage API first: configurator.js reads window.SFBasket on click.
		wp_enqueue_script('sinofresh-basket', get_template_directory_uri() . '/assets/js/basket.js', array(), '1.0.0', true);
		wp_enqueue_script('sinofresh-configurator', get_template_directory_uri() . '/assets/js/configurator.js', array(), '1.9', true);
		// Hero card carousel on the 8 dosage pages (same paradigm as the home slider).
		wp_enqueue_script('sinofresh-product-slider', get_template_directory_uri() . '/assets/js/product-slider.js', array(), '1.0.0', true);
