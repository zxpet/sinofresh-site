...
add_action('wp_enqueue_scripts', function() {
	wp_enqueue_style('sinofresh-style', get_stylesheet_uri(), array(), '2.10.32');
...
wp_enqueue_script('sinofresh-basket', get_template_directory_uri() . '/assets/js/basket.js', array(), '1.2.0', true);
	if (is_front_page()) {
