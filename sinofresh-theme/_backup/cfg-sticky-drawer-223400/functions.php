...
add_action('wp_enqueue_scripts', function() {
	wp_enqueue_style('sinofresh-style', get_stylesheet_uri(), array(), '2.8.1');
...
add_action('admin_init', function () {
	...
	$text_fields = array('sf_working_hours', 'sf_contact_phone', 'sf_contact_address', 'sf_contact_whatsapp');
