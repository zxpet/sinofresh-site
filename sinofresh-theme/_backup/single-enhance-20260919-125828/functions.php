...
add_action('wp_enqueue_scripts', function() {
	wp_enqueue_style('sinofresh-style', get_stylesheet_uri(), array(), '2.10.37');
	...
	// On-this-page dot-rail TOC: long marketing pages only (JS no-ops with < 3 H2s).
	if (is_front_page() || is_page(array('quality', 'about', 'services', 'factory-tour', 'soft-chews', 'tablets', 'powders', 'pastes', 'drops', 'liquids', 'fish-oil', 'dental-chews'))) {
		wp_enqueue_script('sinofresh-toc-nav', get_template_directory_uri() . '/assets/js/toc-nav.js', array(), '1.0.0', true);
	}
	if (is_front_page()) {
...
add_action('wp_enqueue_scripts', function() {
	...
	if ($is_dosage_page) {
		wp_enqueue_style('sinofresh-configurator', get_template_directory_uri() . '/assets/css/configurator.css', array(), '2.8');
